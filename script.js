...
Each vehicle instance should have access to a method called ***honk***, which returns the 
string “Beep.”
...
class Garage {
    ...
    add (vehicleAddition) {
        if (!(vehicleAddition instanceof Vehicle)) {
        ...
        this.vehicles.push(vehicleAddition);
